...
# Add the affine directory to the Python path to access shared modules
affine_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'affine')
if affine_dir not in sys.path:
    sys.path.append(affine_dir)
